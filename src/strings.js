...
export const I18N = {
  es: {
    ...
    values: {
      ...
      search: "Buscar unidad…",
      votes_hint:
        "Solo se muestran valores de voto únicos por unidad. Pasa el cursor sobre una pastilla para ver todos los votos agrupados.",
      col_unit: "Unidad",
      col_rarity: "Rareza",
      col_base: "Valor base",
      col_demand: "Demanda",
  ...
  en: {
    ...
    values: {
      ...
      search: "Search unit…",
      votes_hint:
        "Only unique vote values per unit are shown. Hover a pill to see all grouped votes.",
      col_unit: "Unit",
      col_rarity: "Rarity",
      col_base: "Base value",
      col_demand: "Demand",
